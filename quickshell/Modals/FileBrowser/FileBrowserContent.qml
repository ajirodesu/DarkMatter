...
// CacheData is a singleton, available via qs.Common
...
FocusScope {
    ...
    property bool selectFolderMode: true
    ...
    Column {
        ...
        Item {
            ...
            FileBrowserFolderSelectRow {
                id: folderSelectRow
                anchors.bottom: parent.bottom
                anchors.left: parent.left
                anchors.right: parent.right
                anchors.margins: Theme.spacingL
                selectFolderMode: root.selectFolderMode
                currentPath: root.currentPath
            ...
            KeyboardHints {
                ...
                anchors.bottom: (root.selectFolderMode || root.saveMode) ? (root.selectFolderMode ? folderSelectRow.top : saveRow.top) : parent.bottom
                anchors.bottomMargin: (root.selectFolderMode || root.saveMode) ? Theme.spacingS : Theme.spacingL
                anchors.left: parent.left
                anchors.right: parent.right
                anchors.leftMargin: Theme.spacingL
