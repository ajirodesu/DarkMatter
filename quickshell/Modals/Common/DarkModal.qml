...
PanelWindow {
    ...
    property real cornerRadius: Math.max(Theme.cornerRadius, 16)
    ...
    Rectangle {
        ...
        color: Qt.rgba(root.backgroundColor.r, root.backgroundColor.g, root.backgroundColor.b, SettingsData.modalTransparency)
        radius: root.cornerRadius
        border.color: Qt.rgba(root.borderColor.r, root.borderColor.g, root.borderColor.b, SettingsData.settingsBorderOpacity || 0.30)
        border.width: SettingsData.settingsBorderThickness || root.borderWidth
