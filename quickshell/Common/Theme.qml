...
Singleton {
    ...
    property real fontSizeXS: Math.max(1, Math.round((fontScale || 1.0) * 10))
    property real fontSizeSmall: Math.max(1, Math.round((fontScale || 1.0) * 12))
    ...
    function getScaleFactor() {
        ...
        if (typeof Screen !== 'undefined') {
            ...
            else if (screenHeight >= 1440) base = 1.1
            else if (screenHeight >= 1080) base = 1.0
            else if (screenHeight >= 720) base = 0.85
            else base = 0.7
        }
