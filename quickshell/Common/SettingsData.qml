...
Singleton {
    ...
    property string controlCenterPosition: "follow-trigger"
    property string notificationCenterPosition: "top-right"
    property string appDrawerPosition: "follow-trigger"
    property string applicationsPosition: "center"
    ...
    property real fontLetterSpacing: -5.0
    ...
    onApplicationsPositionChanged: saveSettings()
    ...
    function parseSettings(content) {
        ...
        desktopGpuSelection = settings.desktopGpuSelection !== undefined ? settings.desktopGpuSelection : "auto"
                ...
                applicationsPosition = settings.applicationsPosition !== undefined ? settings.applicationsPosition : "center"
                ...
                fontLetterSpacing = settings.fontLetterSpacing !== undefined ? settings.fontLetterSpacing : -5.0
                fontWordSpacing = settings.fontWordSpacing !== undefined ? settings.fontWordSpacing : 0.0
    ...
    function applyHandheldMode() {
        ...
        controlCenterDropShadowOpacity = 1
        ...
        launcherLogoDropShadowOpacity = 0.69
        dockIconDropShadowOpacity = 0
        topBarDropShadowOpacity = 1

        // DarkDash settings
        darkDashTransparency = 0.92
        darkDashDropShadowOpacity = 0.15
        ...
        desktopDarkDashDropShadowOpacity = 1
        ...
        appDrawerPosition = "bottom-center"
        applicationsPosition = "bottom-center"
        ...
        // Dock widget order
        dockLeftWidgets = [{"id": "launcherButton", "enabled": true}, {"id": "workspaceSwitcher", "enabled": true}, {"id": "launchpad", "enabled": true}]
        dockRightWidgets = [{"id": "music", "enabled": true}, {"id": "systemTray", "enabled": true}, {"id": "weather", "enabled": true}, {"id": "clock", "enabled": true}, {"id": "controlCenterButton", "enabled": true}, {"id": "settingsButton", "enabled": true}]
