...
Item {
    ...
    MouseArea {
        ...
        onPositionChanged: mouse => {
                               ...
                               // Calculate offset along the dock axis (vertical or horizontal)
                               ...
                               const spacing = Math.min(8, Math.max(4, SettingsData.dockIconSize * 0.08))
                               const itemSize = SettingsData.dockIconSize * 1.2 + spacing
