                    ...
                    try {
                        ...
                        if (current.appDrawerLoader) {
                            ...
                            if (current.appDrawerLoader.item) {
                                ...
                                console.log("=== DOCK APPDRAWER DEBUG ===")
                                console.log("Button rect:", rect.x, rect.y, rect.width, rect.height)
                                console.log("Button center:", rect.x + rect.width/2, rect.y + rect.height/2)
                                ...
                                console.log("Dock thickness:", dockThickness)
                                ...
                                // The DarkPopout centering logic will handle centering the popup on the button
                                ...
                                if (current.appDrawerLoader.item.setTriggerPosition) {
                                    console.log("Setting trigger position on appDrawerLoader.item")
                                    current.appDrawerLoader.item.setTriggerPosition(triggerX, triggerY, rect.width, "dock", Screen)
                                } else {
                                    console.log("setTriggerPosition not available on appDrawerLoader.item")
                                }
                        ...
                        if (typeof appDrawerLoader !== 'undefined') {
                            ...
                            if (appDrawerLoader.item) {
                                // Get button position and calculate popup position above dock
                                const rect = parent.mapToItem(null, 0, 0, width, height)
                                console.log("=== DOCK APPDRAWER DEBUG (fallback) ===")
                                console.log("Button rect:", rect.x, rect.y, rect.width, rect.height)
                                console.log("Button center:", rect.x + rect.width/2, rect.y + rect.height/2)
                                ...
                                if (appDrawerLoader.item.setTriggerPosition) {
                                    console.log("Setting trigger position on appDrawerLoader.item")
                                    appDrawerLoader.item.setTriggerPosition(triggerX, triggerY, rect.width, "dock", Screen)
                                } else {
                                    console.log("setTriggerPosition not available on appDrawerLoader.item")
                                }
                        ...
                        console.log("Error in dock AppDrawer click:", e)
                    }
                }
            ...
            onClicked: {
                ...
                while (current) {
                    if (current.controlCenterLoader) {
                        ...
                        if (current.controlCenterLoader.item) {
                            ...
                            current.controlCenterLoader.item.setTriggerPosition(triggerX, triggerY, 0, "center", Screen)
                ...
                if (typeof controlCenterLoader !== 'undefined') {
                    ...
                    if (controlCenterLoader.item) {
                        ...
                        controlCenterLoader.item.setTriggerPosition(triggerX, triggerY, 0, "center", Screen)
