...
DarkPopout {
    ...
    function setTriggerPosition(x, y, width, section, screen) {
        // Always set trigger position for dock widgets (they position relative to clicked button)
        // Only use position setting for non-dock triggers
        console.log("=== APPDRAWER POPOUT setTriggerPosition ===")
        console.log("Received trigger position:", x, y, width, section, screen)
        ...
        console.log("Set _calculatedTriggerX/Y:", _calculatedTriggerX, _calculatedTriggerY)
        console.log("_triggerPositionSet:", _triggerPositionSet)
    }

    readonly property bool isBarVertical: SettingsData.topBarPosition === "left" || SettingsData.topBarPosition === "right"
    
    // Track if trigger position was explicitly set (e.g., from dock)
    ...
    popupWidth: 800
    popupHeight: 800
    // Always use trigger position when set (for dock widgets), otherwise use position setting
    property real _effectiveTriggerX: _triggerPositionSet ? _calculatedTriggerX : 0
    triggerX: _effectiveTriggerX
    property real _effectiveTriggerY: _triggerPositionSet ? _calculatedTriggerY : 0
    triggerY: _effectiveTriggerY

    on_EffectiveTriggerXChanged: console.log("_effectiveTriggerX changed to:", _effectiveTriggerX)
    on_EffectiveTriggerYChanged: console.log("_effectiveTriggerY changed to:", _effectiveTriggerY)
    triggerWidth: 40
    positioning: "center"
                    ...
                    DarkTextField {
                        ...
                        Connections {
                            ...
                            DarkListView {
                                ...
                                width: parent.width
                                height: parent.height - (48 + Theme.spacingL * 2)
                                y: 48 + Theme.spacingL * 2
                                clip: true
