                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        const x = 50
                                        const y = 50 + Theme.barHeight + Theme.spacingS
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        const x = 50
                                        const y = Math.max(0, Screen.height - (parentModal ? parentModal.height : getDefaultHeight()) - 50 - Theme.barHeight - Theme.spacingS)
                                        SettingsData.setSettingsWindowX(x)
                                        SettingsData.setSettingsWindowY(y)
                                        if (parentModal) {
                                            parentModal.positioning = "custom"
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                cursorShape: Qt.PointingHandCursor
                                onClicked: {
                                    SettingsData.setSettingsWindowX(-1)
                                    SettingsData.setSettingsWindowY(-1)
                                    if (parentModal) {
                                        parentModal.positioning = "custom"
