...
Item {
    ...
    DarkFlickable {
        ...
        Column {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    DarkDropdown {
                        ...
                        description: {
                            const descriptions = {
                                "follow-trigger": "Position relative to button",
                            ...
                            return descriptions[SettingsData.appDrawerPosition] || "Choose positioning"
                        }
                        currentValue: {
                            const labels = {
                            ...
                            return labels[SettingsData.appDrawerPosition] || "Follow Trigger"
                        }
                        options: ["Follow Trigger", "Center", "Top Left", "Top Center", "Top Right", "Bottom Left", "Bottom Center", "Bottom Right"]
                        onValueChanged: value => {
                            ...
                            SettingsData.appDrawerPosition = values[value] || "follow-trigger"
                        }
                    }
                }
            }
                ...
                Column {
                    ...
                    DarkDropdown {
                        ...
                        description: {
                            ...
                            return descriptions[SettingsData.controlCenterPosition] || "Choose positioning"
                        }
                        currentValue: {
                            const labels = {
                                "follow-trigger": "Follow Trigger",
                            ...
                            return labels[SettingsData.controlCenterPosition] || "Follow Trigger"
                        }
                        options: ["Follow Trigger", "Center", "Top Left", "Top Center", "Top Right", "Bottom Left", "Bottom Center", "Bottom Right"]
                        onValueChanged: value => {
                            const values = {
                            ...
                            SettingsData.controlCenterPosition = values[value] || "follow-trigger"
                        }
                    }
                }
            }
            ...
            StyledRect {
                width: Math.min(parent.width * 1.2, parent.parent ? parent.parent.width - 48 : parent.width * 1.2)
                height: applicationsPositionSection.implicitHeight + Theme.spacingL * 2
                anchors.horizontalCenter: parent.horizontalCenter
                radius: Theme.cornerRadius
                color: Qt.rgba(Theme.surfaceVariant.r, Theme.surfaceVariant.g,
                               Theme.surfaceVariant.b, 0.3)
                ...
                Column {
                    id: applicationsPositionSection
                    ...
                    StyledText {
                        text: "Choose where the Applications launcher menu appears when clicked"
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceVariantText
                        wrapMode: Text.WordWrap
                        width: parent.width
                    ...
                    DarkDropdown {
                        ...
                        description: {
                            ...
                            return descriptions[SettingsData.applicationsPosition] || "Choose positioning"
                        }
                        currentValue: {
                            const labels = {
                                "follow-trigger": "Follow Trigger",
                            ...
                            return labels[SettingsData.applicationsPosition] || "Center"
                        }
                        options: ["Follow Trigger", "Center", "Top Left", "Top Center", "Top Right", "Bottom Left", "Bottom Center", "Bottom Right"]
                        onValueChanged: value => {
                            const values = {
                            ...
                            SettingsData.applicationsPosition = values[value] || "center"
                        }
                    }
                }
            }
