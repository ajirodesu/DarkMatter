...
Item {
    ...
    function saveMonitorsConf() {
        ...
        // Trim leading blank lines from original content
        var startIndex = 0
                        ...
                        delegate: Column {
                            ...
                            DarkButtonGroup {
                                ...
                                currentIndex: {
                                    ...
                                    if (vrrValue === "0" || vrrValue === 0 || vrrValue === false) return 0
                                    if (vrrValue === "1" || vrrValue === 1 || vrrValue === true) return 1
                                    if (vrrValue === "2" || vrrValue === 2) return 2
                                    return 0
                                }
                                onSelectionChanged: (index, selected) => {
                                    if (!modelData || !selected) return
                                    var newValue = "0"
                                    if (index === 1) newValue = "1"
                                    else if (index === 2) newValue = "2"
