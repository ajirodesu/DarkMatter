                ...
                Column {
                    ...
                    Column {
                        ...
                        DarkSlider {
                            width: parent.width
                            height: 24
                            value: (SettingsData.startMenuXOffset + 1.0) * 50
                            minimum: 0
                            maximum: 100
                            unit: "%"
                            showValue: true
                    ...
                    Column {
                        ...
                        DarkSlider {
                            width: parent.width
                            height: 24
                            value: (SettingsData.startMenuYOffset + 1.0) * 50
                            minimum: 0
                            maximum: 100
                            unit: "%"
                            showValue: true
                ...
                Column {
                    ...
                    Column {
                        ...
                        DarkSlider {
                            width: parent.width
                            height: 24
                            value: (SettingsData.controlCenterXOffset + 1.0) * 50
                            minimum: 0
                            maximum: 100
                            unit: "%"
                            showValue: true
                    ...
                    Column {
                        ...
                        DarkSlider {
                            width: parent.width
                            height: 24
                            value: (SettingsData.controlCenterYOffset + 1.0) * 50
                            minimum: 0
                            maximum: 100
                            unit: "%"
                            showValue: true
