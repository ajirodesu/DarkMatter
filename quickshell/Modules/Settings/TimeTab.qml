...
Item {
    ...
    // Timer removed - was empty and causing unnecessary CPU usage
        ...
        Column {
                                ...
                                text: {
                                    ...
                                    if (SettingsData.use24HourClock) {
                                        if (SettingsData.showAmPmIn24Hour) {
                                            ...
                                            return timeStr + " " + now.toLocaleDateString(Qt.locale(), Locale.LongFormat)
                                        }
                                    } else {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    DarkToggle {
                        width: parent.width
                        text: "Show AM/PM in 24-hour mode"
                        description: "Display AM/PM indicators when using 24-hour time format"
                        checked: SettingsData.showAmPmIn24Hour
                        onToggled: checked => {
                            SettingsData.setShowAmPmIn24Hour(checked)
                        }
                    }
