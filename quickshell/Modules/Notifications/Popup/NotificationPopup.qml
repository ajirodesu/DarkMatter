...
PanelWindow {
    ...
    color: "transparent"
    implicitWidth: 400
    property real contentHeight: notificationContent ? notificationContent.implicitHeight : 98
    implicitHeight: 24 + contentHeight
    ...
    Item {
        ...
        Rectangle {
            ...
            Item {
                ...
                readonly property real implicitHeight: {
                    const iconHeight = 63
                    const textColumnHeight = textColumn.implicitHeight || 0
                    return Math.max(iconHeight, textColumnHeight) + 8 // bottom margin
                }
            ...
            Row {
                ...
                anchors.bottom: notificationContent.bottom
                anchors.bottomMargin: 8
                spacing: 8
                z: 20
