...
DarkPopout {
    ...
    readonly property real basePopupWidth: 495
    ...
    function calculateTriggerX() {
        if (_triggerPositionSet) {
            return _calculatedTriggerX
        }
    ...
    triggerX: calculateTriggerX()
    triggerY: _triggerPositionSet ? _calculatedTriggerY : 0
    triggerWidth: 80
    positioning: "center"
