                ...
                function updatePosition() {
                    ...
                    if (menuRoot.isVertical) {
                        ...
                        if (menuRoot.isAtBottom) {
                            const rect = menuRoot.anchorItem.mapToItem(null, 0, 0, menuRoot.anchorItem.width, menuRoot.anchorItem.height)
                            ...
                            targetX = screenX + menuRoot.anchorItem.width / 2
                            targetY = screenY
                        } else {
                            const globalPos = menuRoot.anchorItem.mapToGlobal(0, 0)
                            ...
                            targetX = relativeX + menuRoot.anchorItem.width / 2
                        ...
                        if (menuRoot.isVertical) {
                            ...
                            if (menuRoot.isAtBottom) {
                                ...
                                if (typeof SettingsData !== "undefined" && SettingsData.dockExclusiveZone > 0) {
                                    dockThickness = SettingsData.dockExclusiveZone + (SettingsData.dockBottomGap || 0) + ((SettingsData.dockTopPadding || 0) * 2)
                                } else if (typeof SettingsData !== "undefined") {
                                    dockThickness = (SettingsData.dockHeight || 80) + (SettingsData.dockBottomGap || 0) + ((SettingsData.dockTopPadding || 0) * 2)
                                }
                                ...
                                const totalBottomSize = dockThickness + bottomBarSize
                                
                                const triggerTop = menuWindow.anchorPos.y
                                let targetY = triggerTop - menuHeight - spacing
                                
                                const maxMenuBottom = menuWindow.screen.height - totalBottomSize - spacing
                                const minMenuTop = maxMenuBottom - menuHeight
                                targetY = Math.min(targetY, minMenuTop)
                                ...
                                return Math.max(minY + topBarSize, targetY)
                            } else {
