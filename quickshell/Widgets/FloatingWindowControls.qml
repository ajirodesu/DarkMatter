...
Item {
    ...
    property bool supported: typeof targetWindow.startSystemMove === "function" || typeof targetWindow.requestMove === "function"
    readonly property bool canMaximize: supported
